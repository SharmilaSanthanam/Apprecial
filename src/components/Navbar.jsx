 ...
 <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 '>
   ...
   {/* <h1>Apprecial</h1> */}
    <ul className='hidden md:flex'>
        <li className='p-4 no-underline hover:underline  hover:text-red-700 active:text-red-700'><a href="#">Home</a></li>
        <li className='p-4 no-underline hover:underline  hover:text-red-700'><a href="#about">About</a></li>
        <li className='p-4 no-underline hover:underline  hover:text-red-700'><a href="#products">Products</a></li>
        <li className='p-4 no-underline hover:underline  hover:text-red-700'><a href="#timeline">Timeline</a></li>
    </ul>
  ...
  {/* <li> <a href="#" target="_blank" rel="noreferrer">
        <img src={Dashboard3} alt="Dashboard3"></img>
      </a></li>  */}

{isLoggedIn === "true" ? (
   <li>  <img className='mt-7 hidden ' src={Theme} alt="Theme"></img> </li>
     )
    : 
    ( 
      <li>  <img className='mt-7 ' src={Theme} alt="Theme"></img> </li>
      )}
